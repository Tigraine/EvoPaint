 ...
 */
public class LeastEnergyTargetSelection extends AbstractTargetSelection {

    public LeastEnergyTargetSelection(List<RelativeCoordinate> directions) {
        super("with the least energy", directions);
    }

    public LeastEnergyTargetSelection() {
        super("with the least energy");
    }
